<template>
  <view>
    <view class="border-top border-light-secondary p-3">
      ...
      <view><text class="font-sm text-muted">请选择充值的金币</text></view>
      ...
      <view class="position-fixed left-0 bottom-0 right-0 border-top flex px-3 align-center" style="height: 100rpx;">
        ...
        <view class="bg-main rounded flex align-center justify-center ml-auto" style="width: 150rpx; height: 70rpx;"><text class="text-white font-md">去充值</text></view>
      </view>
