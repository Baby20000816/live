<template>
	<view class="border-top border-light-secondary p-3">
		...
		<view class="flex flex-wrap" style="margin-left: -20rpx; margin-right: -20rpx;">
			<view class="p-2" style="width: 33.3%;box-sizing: border-box;" v-for="i in 6" :key="i">
				<view class="border rounded flex flex-column align-center justify-center" style="height: 130rpx;">
